                        ...
                        <div class="form-horizontal">
                            <div class="col-sm-10">
                                <select class="form-control" name="jenis_kelamin" id="pilihandosen1">
                                    <option selected disabled hidden value="{{$value->jenis_kelamin}}">{{$value->jenis_kelamin}}</option>
                        ...
                        <div class="form-horizontal">
                            <div class="col-sm-10">
                                <select id="jabatan" class="form-control" required name="jabatan">
                                    <option selected disabled hidden value="{{$value->id_jabatans}}">{{$value->nama_jabatan}}</option>
                        ...
                        <div class="form-horizontal">
                            <div class="col-sm-10">
                                <select id="bagian" class="form-control" required name="bagian">
                                    <option selected disabled hidden value="{{$value->id_bagians}}">{{$value->nama_bagian}}</option>
                        ...
                        <div class="form-horizontal">
                            <div class="col-sm-10">
                                <select id="rootjabatan" class="form-control" required name="rootjabatan">
                                    <option selected disabled hidden value="{{$value->id_rootJabs}}">{{$value->root_jab}}</option>
                        ...
                        <div class="form-horizontal">
                            <div class="col-sm-10">
                                <select id="authority" class="form-control" required name="authority">
                                    <option selected disabled hidden value="{{$value->authority}}">{{$value->authority}}</option>
