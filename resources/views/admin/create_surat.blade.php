                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <select name="jenis_surat" class="form-control r-0 light s-12" required="">
                                        ...
                                        <div class="form-group m-0">
                                            <label for="status_disposisi" class="col-form-label s-12">Status Disposisi</label>
                                            <input name="status_disposisi" class="form-control r-0 light s-12 " type="text">
                                        </div>
                                        <div class="form-group m-0">
