        ...
        <div class="animated fadeInUpShort">
            <div class="row my-3">
                <div class="col-md-7  offset-md-2">
                    <form accept-charset="UTF-8" role="form" action="{{ URl('admin/edit-rootjab') }}" method="post">
                        <fieldset>
                        @csrf
                        <div class="card no-b  no-r">
                            @foreach ($rootjabatan as $value)

                            <div class="card-body">
                                <h5 class="card-title">Edit Root Jabatan</h5>
                                <div class="form-row">
                                    <div class="col-md-8">
                                        <div class="form-group m-0">
                                            <input type="hidden" name="id_rootJab" value="{{$value->id_rootJab}}">
                                                    <label for="root_jab" class="col-form-label s-12">Nama Root Jabatan</label>
                                                    <input name="root_jab" value="{{$value->root_jab}}"
                                                           placeholder="Masukan Root Jabatan"
